...
**Plans**: 1 plan
Plans:
- [ ] 05-01-PLAN.md — Ingest, normalize, and filter GTFS-RT service alerts (fetch, model, boot-triggered 5-min poll, active-window query)
...
| 5. Service Alerts Ingestion | 0/1 | Not started | - |
