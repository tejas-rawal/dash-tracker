...
| DASH/Swiftly upstream -> ServiceAlertRepository | The server trusts upstream-sourced alert text/IDs (ingestion itself is unchanged, owned by Phase 8). | Alert records including `informedRouteIds`/`informedStopIds` |
...
|---------|------------|-----------|-------------|------|
| AR-06-01 | T-06-01 | ID matching trusts the same upstream source on both sides of the comparison; no user-controlled input, no auth/integrity impact even in worst case. | plan-time threat model (09-01-PLAN.md) | 2026-09-04 |
| AR-06-02 | T-06-02 | Alert content is public transit-service information; D-01 already trims sensitive fields (url/informedRouteIds/informedStopIds). | plan-time threat model (09-01-PLAN.md) | 2026-09-04 |
| AR-06-04 | T-06-04 | Same rationale as T-06-01, stop-side. | plan-time threat model (09-02-PLAN.md) | 2026-09-04 |
| AR-06-05 | T-06-05 | Same rationale as T-06-02, stop-side. | plan-time threat model (09-02-PLAN.md) | 2026-09-04 |
